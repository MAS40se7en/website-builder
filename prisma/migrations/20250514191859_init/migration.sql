...
CREATE TABLE `Funnel` (
    ...
    `favicon` TEXT NULL,
    `subAccountId` VARCHAR(191) NOT NULL,
    `liveProducts` VARCHAR(191) NOT NULL DEFAULT '[]',
...
CREATE TABLE `Notification` (
    ...
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
    `notificaiton` VARCHAR(191) NOT NULL,
    `agencyId` VARCHAR(191) NOT NULL,
    `subAccountId` VARCHAR(191) NULL,
...
CREATE TABLE `Subscription` (
    ...
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
    `plan` ENUM('price_1', 'price_2') NULL,
    `price` VARCHAR(191) NOT NULL,
    `active` BOOLEAN NOT NULL DEFAULT false,
    `priceId` VARCHAR(191) NOT NULL,
    `customerId` VARCHAR(191) NOT NULL,
    `currenPeriodEndDate` DATETIME(3) NOT NULL,
